				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						<tbody>
							...
							<td align="right" width="10%">上传新图片：</td>
							<td width="30%">
								<a  href="javascript:void(0)" onclick="showPreAdPhoto('${modifyObj.img}')">查看原图片</a>
								<input type="hidden" name="img" value="${modifyObj.img}"/>
								<input type="hidden" name="imgFileName" value="${modifyObj.imgFileName}"/>						
								<input id="imgFile" name="imgFile" onchange='PreviewImage(this)' class="allInput" style="width:100%;" type="file"/>
