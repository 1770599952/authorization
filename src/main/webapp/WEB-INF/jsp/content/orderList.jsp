...
<link rel="stylesheet" type="text/css"
	href="${basePath}/css/jquery.validate.css" />
   	    <script type="text/javascript" src="${basePath}/js/common/jquery.min.js"></script>
<script type="text/javascript"
	src="${basePath}/js/common/validation/jquery.validate.js"></script>
<script type="text/javascript"
	src="${basePath}/js/common/validation/messages_zh.js"></script>
...
<body style="background: #e1e9eb;">
	<form action="${basePath}/orders/search" id="mainForm" method="post">
		...
		<input type="hidden" id="id" name="id" /> <input type="hidden"
			...
			id="basePath" value="${basePath}" /> <input type="hidden"
			name="page.currentPage" id="currentPage" value="1" />
		<div class="right">
			<div class="current">
				当前位置：<a href="#">内容管理</a> &gt; 订单查询
			</div>
			<div class="rightCont">
				...
				<table class="tab1">
					<tbody>
						<tr>
							...
							<td><input name="member.phone" id="member.phone" value="" class="allInput"
								type="text" /></td>
