 ...
 */
function assignMenu() {
	// 20180114 17点04分 getSelectedNodes此方法与getCheckedNodes的区别在于；
	// getSelectedNode获取的是选中的节点，
	// getCheckedNodes获取的是节点前的选择框被勾选的节点。
